...
{
    public class Admin_ManageBlockedAccModel : PageModel
    {
        ...
        public void GetUsers(string sortUser)
        {
            try
            {
                ...
                {
                    connection.Open();
                    string sql = "select * from LoginCustomer where accstatus='false' "; //getting the data based from the pdid variable
        ...
        public IActionResult OnGetUnblock()
        {
            string id = Request.Query["id"];
            try
            {
                ...
                {
                    connection.Open();
                    String sql2 = "update LoginCustomer set accstatus='true' where Id='" + id + "'";
            ...
            return Redirect("/Admin_ManageBlockedAcc");
        }
