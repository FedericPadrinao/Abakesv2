...
namespace abakes2.Pages
{
    public class Admin_Manage3DOrders2Model : PageModel
    {
        ...
        public void GetOrders()
        {
            ...
            {
                Console.WriteLine("Error Reading 3D Orders2: " + e.ToString());
        ...
        public IActionResult OnGetReject()
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    string sql = "delete from Order3DForm WHERE OrderID=@ID"; //getting the data based from the pdid variable
                    using (SqlCommand command = new SqlCommand(sql, connection))
                    {
                        command.Parameters.AddWithValue("@ID", id);
            ...
            return Redirect("/Admin_Manage3DOrders2");
        }
